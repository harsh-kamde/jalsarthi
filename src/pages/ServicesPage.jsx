...
import img1 from "../assets/team/water-usage.avif"; // Replace with relevant image
import img2 from "../assets/team/water-usage.avif"; // Replace with relevant image
import img3 from "../assets/team/water-usage.avif"; // Replace with relevant image
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <title>
          JalSaarthi Services - Water Usage Management, Distribution Control, and Leakage Detection
        </title>
        <meta
          name="title"
      ...
      <section className="container">
        <div id="service-section">
          <div className="section-title text-center">
            <h2>Our Services</h2>
            <p style={{ color: "var(--textLight)" }}>Here are the services we offer</p>
          </div>
          ...
          <div className="my-cards">
            <div className="service-card">
              ...
              <div className="content">
                ...
                <p>
                  Efficiently monitor and manage water usage in households to ensure optimal resource allocation and prevent wastage.
                </p>

                <Button onClick={navigateToUsageManagement}>Manage Usage</Button>
              </div>
            </div>
            ...
            <div className="service-card">
              ...
              <div className="content">
                ...
                <p>
                  Oversee and control the distribution of water across various areas to maintain an effective and equitable supply.
                </p>
            ...
            <div className="service-card">
              ...
              <div className="content">
                ...
                <p>
                  Detect and address leaks promptly to prevent water loss and ensure the integrity of the distribution system.
                </p>
                <Button onClick={showModal}>Report a Leakage</Button>
              </div>
            </div>
          </div>
